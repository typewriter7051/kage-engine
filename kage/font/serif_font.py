...
class SerifFont(Font):
    ...
    def __adjust_stroke(self):
        ...
        self.__adjust_tate()      # 縦画
        self.__adjust_kakato()    # カカト
        self.__adjust_uroko()     # ウロコ, horizontal strokes' terminal (triangle)
        self.__adjust_uroko2()    # ウロコ
        self.__adjust_kirikuchi() # 払い, 

    def __adjust_hane(self):
        vert_segments = [
            Namespace(
                **{
